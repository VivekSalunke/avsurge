  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-[var(--text)]">
      <div className="text-sm text-[rgba(255,255,255,0.4)] mb-6 flex items-center gap-1.5">
        ...
        <span>&rsaquo;</span>
        <span className="text-[rgba(255,255,255,0.65)]">Editorial Policy</span>
      </div>

      <h1 className="text-3xl font-bold text-white mb-2">Editorial Policy</h1>
      <p className="text-sm text-[rgba(255,255,255,0.4)] mb-10">Last updated: August 2026</p>

      <div className="prose prose-sm max-w-none space-y-8">

        <section>
          <h2 className="text-lg font-bold text-white mb-3">1. Our Mission</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">3. Editorial Independence</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">5. AI-Generated Content</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">10. Questions</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
            If you have questions about how we source information, handle affiliate relationships, or make editorial decisions, reach out via our <Link href="/contact" className="text-neon-cyan hover:underline">Contact page</Link>.
          </p>
        </section>
