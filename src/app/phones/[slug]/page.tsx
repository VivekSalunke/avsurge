      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1">
          <div className="bg-[var(--card-bg)] rounded-2xl border border-[rgba(255,255,255,0.06)] p-6 sticky top-20">
            <div className="w-full aspect-square bg-[rgba(255,255,255,0.02)] rounded-xl flex items-center justify-center mb-5 text-7xl overflow-hidden relative">
              {phone.image_url
                ? <Image src={phone.image_url} alt={phone.name} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-contain w-full h-full p-2" />
                : '📱'}
            </div>
