  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-[var(--text)]">
      <div className="text-sm text-[rgba(255,255,255,0.4)] mb-6 flex items-center gap-1.5">
        ...
        <span>&rsaquo;</span>
        <span className="text-[rgba(255,255,255,0.65)]">Privacy Policy</span>
      </div>

      <h1 className="text-3xl font-bold text-white mb-2">Privacy Policy</h1>
      <p className="text-sm text-[rgba(255,255,255,0.4)] mb-10">Last updated: July 2026</p>
      ...
      <div className="prose prose-sm max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed mb-3">We collect information you provide directly to us, including:</p>
          ...
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed mt-3">We also collect certain information automatically when you visit our site, including:</p>
          <ul className="list-disc list-inside text-[rgba(255,255,255,0.65)] space-y-2 ml-2">
        ...
        <section>
          ...
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed mb-3">We use the information we collect to:</p>
          <ul className="list-disc list-inside text-[rgba(255,255,255,0.65)] space-y-2 ml-2">
        ...
        <section>
          ...
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed mb-3">You have the right to:</p>
          <ul className="list-disc list-inside text-[rgba(255,255,255,0.65)] space-y-2 ml-2">
