  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-[var(--text)]">
      <div className="text-sm text-[rgba(255,255,255,0.4)] mb-6 flex items-center gap-1.5">
        ...
        <span>&rsaquo;</span>
        <span className="text-[rgba(255,255,255,0.65)]">Terms and Conditions</span>
      </div>
      ...
      <div className="prose prose-sm max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">4. Price Alerts</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">6. User-Generated Content</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">7. Affiliate Links and Advertising</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">9. Third-Party Links</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-white mb-3">12. Prohibited Activities</h2>
          <p className="text-[rgba(255,255,255,0.65)] leading-relaxed mb-3">You agree not to:</p>
